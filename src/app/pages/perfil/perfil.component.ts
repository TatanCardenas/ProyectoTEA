...
export class PerfilComponent implements OnInit {
  ...
  datos(){
    ...
    this.usuarioService.datosDocente(user).subscribe(data =>{
      ...
      this.nombre = this.usuarioDocente.nombre;
  ...
  private formDocente() {
    ...
    this.form = this.formBuilder.group({
      ...
      nombre_docente: [this.datosDocente.nombre, [Validators.required,Validators.maxLength(20), Validators.minLength(3),Validators.pattern(/[A-Za-z]/)]],
      apellido_docente: [this.datosDocente.apellido, [Validators.required,Validators.minLength(4),, Validators.maxLength(20), Validators.pattern(/[A-Za-z]/)]],
      cedula: [this.datosDocente.documento, [Validators.required, Validators.minLength(6), Validators.maxLength(11), Validators.pattern(/[0-9]/)]],
